...
//        /// </summary>
//        public class StayEffect : EffectState
//        {
//            public GameObject[] LaunchObjects;
//            GameObject clones;

//            public const string MyKey = "StayEffect";

//            public StayEffect(string key, params string[] newTransition) : base(MyKey, newTransition)
//            {
//                Key = key;
//                Transition = newTransition;

//                effectInfos.Add(11, new EffectInfo("MusaS3"));
//                effectInfos.Add(12, new EffectInfo("MagicianS3"));
...
//            GameObject Test;
//            public override void CloneCraft()                                                   //제자리 이펙트 생성 메소드
//            {
